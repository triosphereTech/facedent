      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="mt-10 grid gap-y-5 sm:grid-cols-2">
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[#eef8f8]"
                  >
                    <Check
                      size={18}
                      className="text-[#2DBBC4]"
          ...
          <div className="relative">
            ...
            {/* IMAGE CONTAINER */}
            <div className="relative overflow-hidden rounded-tl-[96px] rounded-tr-[32px] rounded-br-[32px] rounded-bl-[32px] border border-[#dbe7ea] bg-white p-4 shadow-[0_20px_50px_-35px_rgba(14,42,71,0.45)]">
              <RoundedImage
                src={clinicImages.aboutHome}
                alt="FaceDent Clinic"
                sizes="(min-width: 1024px) 50vw, 100vw"
                className="h-[620px] rounded-tl-[84px] rounded-tr-[24px] rounded-br-[24px] rounded-bl-[24px] border-0 shadow-none"
              />

              {/* FLOAT CARD */}
              <div
                className="absolute bottom-8 left-8 rounded-[28px] border border-white/60 bg-white/85 p-5 shadow-[0_15px_40px_rgba(15,42,71,0.08)] backdrop-blur-xl"
              >
                
                <div className="flex items-start gap-4">
                  
                  <div
                    className="flex h-14 w-14 items-center justify-center rounded-full bg-[#eef8f8]"
                  >
                    <HeartHandshake
                      size={24}
                      className="text-[#2DBBC4]"
        ...
        {/* CTA SECTION */}
        <div
          className="relative mt-14 overflow-hidden rounded-[40px] bg-gradient-to-r from-[#0E2A47] via-[#123454] to-[#2DBBC4] px-8 py-16"
        >
          ...
          <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
            ...
            {/* BUTTON */}
            <button
              className="flex h-[60px] w-fit items-center gap-3 rounded-full bg-white px-8 text-[15px] font-medium text-[#0E2A47] transition-all duration-300 hover:scale-[1.03]"
            >
              Book Consultation
              <ArrowRight size={18} />
            </button>
